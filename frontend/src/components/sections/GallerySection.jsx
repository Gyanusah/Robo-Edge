  ...
  return (
    <section id="gallery" className="section-padding bg-background">
      <div className="container">
        <h2 className="text-4xl sm:text-5xl font-bold text-center mb-12 text-gray-300">
          Gallery
        </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto mb-10">
              {galleryItems.slice(0, 4).map((item) => (
                <div
                  ...
                  className="relative cursor-pointer group overflow-hidden rounded-xl bg-slate-900 border border-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 h-48"
                >
                  {item.type === 'photo' ? (
                    <img
                      src={item.url}
